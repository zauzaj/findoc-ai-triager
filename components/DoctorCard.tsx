...
export default function DoctorCard({ place, insurance }: DoctorCardProps) {
  ...
  return (
    <article className="bg-white rounded border-2 border-[#eef2f6] p-5 shadow-[0_4px_10px_rgba(67,95,113,0.08)] transition-[border-color,box-shadow] duration-300 hover:border-primary-blue">
      <div className="flex items-start gap-4">
        {/* Circular avatar — mirrors patient-app 80px circular avatar with orange placeholder */}
        <div
          className="w-16 h-16 rounded-full bg-primary-orange flex-shrink-0 flex items-center justify-center text-white font-bold text-xl select-none"
          aria-hidden="true"
        >
          {initial}
        </div>
